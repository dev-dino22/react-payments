...
const container$7 = "_container_1rs2o_1";
const content$1 = "_content_1rs2o_12";
const iconWrapper$1 = "_iconWrapper_1rs2o_20";
const cardIcon = "_cardIcon_1rs2o_31";
const messageContainer$1 = "_messageContainer_1rs2o_37";
const title$1 = "_title_1rs2o_42";
const description$1 = "_description_1rs2o_49";
const registerButton = "_registerButton_1rs2o_56";
const styles$b = {
...
function useExpirationDateInput(onSuccessValidate, onSuccessNextInput, onExpirationDateChange) {
  ...
  function onChangeHandler(e, i) {
    ...
    if (nextMonth.length === 2 && nextYear.length === 2 && monthError === "" && yearError === "") {
      ...
      (_b = inputRefs.current[i - 1]) == null ? void 0 : _b.focus();
    } else if (nextMonth.length !== 2 || nextYear.length !== 2 || monthError !== "" || yearError !== "") {
      onSuccessValidate(false);
    }
  }
  return {
