...
function CardPreview({ cardNumbers, expirationDate }) {
  const { brandName } = reactExports.useMemo(() => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.logoContainer, children: [
      ...
      brandName !== "" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: `./${brandName}.png`,
          alt: `${brandName} logo`,
          className: styles$4.logoBrand
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${styles$4.cardNumberBox} tx-md`, children: displayCardNumbers.map((number, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$4.pCardNumber, children: number }, i)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${styles$4.pCardNumber} tx-md`, children: expirationDate.join(CARD_INFO.EXPIRATION_SPLIT) })
  ] });
}
...
const container$1 = "_container_1hf2k_1";
const inputContainer = "_inputContainer_1hf2k_13";
const inputBox = "_inputBox_1hf2k_20";
const titleBox = "_titleBox_1hf2k_30";
const feedbackMessage = "_feedbackMessage_1hf2k_40";
const styles$2 = {
...
function InputForm(props) {
  const { title, label, description, feedbackMessage: feedbackMessage2 } = props;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.titleBox, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "tx-xl", children: title }),
      description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "tx-md", children: description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.inputBox, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "tx-lg", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.inputContainer, children: props.children }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          style: feedbackMessage2 ? { visibility: "visible" } : { visibility: "hidden" },
          className: `${styles$2.feedbackMessage}`,
          children: feedbackMessage2
        }
      )
    ] })
  ] });
...
const cardInputForm = "_cardInputForm_17pi5_1";
const styles$1 = {
  cardInputForm
};
...
const section = "_section_tv0lf_1";
const container = "_container_tv0lf_6";
const styles = {
  section,
  container
};
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PaymentInputPage, {});
}
